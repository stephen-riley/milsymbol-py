...
from ...iconparts.signals_intelligence import signals_intelligence as icons


def signalsIntelligence(ms, sId, sIdm1, sIdm2, bbox, symbolSet, icn, _STD2525, edition):
