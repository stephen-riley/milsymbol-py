...
def landinstallation(ms, sId, sIdm1, sIdm2, bbox, symbolSet, icn, _STD2525, edition):
    # Land Installation
    if symbolSet == "20":
        sId["110000"] = [icn["GR.IC.MILITARY"]]
        sId["110100"] = [icn["GR.IN.IC.AIRCRAFT PRODUCTION & ASSEMBLY"]]
        sId["110200"] = [ms._scale(1.4, icn["GR.IC.FF.CLASS V"], True)]
        ...
        sId["111500"] = [ms._scale(0.8, icn["AC.IC.RADIOACTIVE MATERIAL"], True)]
        ...
        sId["120504"] = [ms._scale(1.5, icn["GR.IC.FF.CLASS III"], True)]
        ...
        sId["121300"] = [ms._scale(1.5, icn["GR.IC.TRANSPORTATION"], True)]
        sId["121301"] = [
