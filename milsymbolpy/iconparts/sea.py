...
def sea(ms, iconParts, metadata, colors, STD2525, monoColor, alternateMedal):
    ...
    icn["SE.IC.AUXILIARY SHIP"] = text("AR" if (STD2525 and not numberSIDC) else "AA")
    ...
    icn["SE.IC.SERVICE CRAFT, YARD, GENERAL"] = text("YY" if STD2525 else "YT")
    ...
    icn["SE.IC.HOVERCRAFT"] = {
        ...
        if STD2525
        else "m 90,80 0,15.6 C 78.4,96.9 70,100.6 70,105 c 0,5.5 13.4,10 30,10 16.6,0 30,-4.5 30,-10 0,-4.4 -8.4,-8.1 -20,-9.4 L 110,80 90,80 z m -15,40 50,0",
    }
    ...
    # Needs special handling for mix of dict and conditional list inclusion
    hovercraft_noncombatant = [
        {
            "type": "path",
            "d": "m 65,100 0,-30 5,10 60,0 5,-10 0,30 10,0 -15,35 -60,0 -15,-35 z",
            "strokewidth": False,
    ...
    if STD2525:
        hovercraft_noncombatant.append(
            {
                "type": "text",
                "alignmentBaseline": "middle",
                "fill": white,
    ...
    icn["SE.IC.HOVERCRAFT NONCOMBATANT"] = hovercraft_noncombatant
    ...
    icn["SE.IC.OWN SHIP"] = {
        "type": "path",
        "fill": False,
        "stroke": iconColor if monoColor else iconFillColor,
    ...
    icn["SE.IC.DITCHED AIRCRAFT"] = {
        "type": "path",
        "fill": iconColor if monoColor else iconFillColor,
        "stroke": iconColor if monoColor else iconFillColor,
    ...
    icn["SE.IC.NAVIGATIONAL"] = {
        "type": "path",
        "fill": False,
        "stroke": iconColor if monoColor else "red",
