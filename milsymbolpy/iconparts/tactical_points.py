...
# from ..ms.ms import ms  # Logic might use ms._scale


def tacticalPoints(ms, iconParts, metadata, colors, STD2525, monoColor, alternateMedal):
    # Tactical points icon parts

    # "iconParts": The existing object of icon parts
    # "metadata": properties object
    # "colors": color object
    # STD2525: Is it 2525 then true, otherwise False
    # "alternateMedal": true/False for sea mine stuff
    ...
    iconColor = (
        "rgb(255, 0, 0)"
        if affiliation == "Hostile" and not monoColor
        else colors["iconColor"][affiliation]
    )
    fillColor = (
        "rgb(255, 0, 0)"
        if affiliation == "Hostile" and not monoColor
        else colors["iconFillColor"][affiliation]
    )
    ...
    icn["TP.NAVIGATIONAL REFERENCE"] = (
        ...
        if not numberSIDC and STD2525
        else {"type": "path", "fill": False, "d": "M 160,160 40,40 M 40,160 160,40"}
    )
    ...
    #     "textanchor": "middle",
    #     "x": 100,
    #     "y": not numberSIDC and not STD2525 ? 145 : 103,
    #     "fontsize": 45,
    #     "text": "K",
    #   },
    #   not numberSIDC and not STD2525 ? { "type": "circle", "cx": 100, "cy": 100, "r": 15 } : [],
    # ]
    ...
    icn["TP.ASW FIXED WING"] = [
        ...
        if not numberSIDC and not STD2525
        else [
            {
                "type": "text",
                "alignmentBaseline": "middle",
            ...
            },
            {
                ...
                if STD2525
                else "M 80,88.3 C 60,80 60,120 80,111.4 L 100.2,99.9 120,111.3 C 140,120 140,80 120,88.6 l -19.8,11.3 z",
                "stroke": False,
            },
        ],
    ]
    ...
    icn["TP.AIR CONTROL RENDEZVOUS"] = [
        icn["TP.AIR CONTROL"],
        {
            ...
            "textanchor": "middle",
            "x": 100,
            "y": 145 if not numberSIDC and not STD2525 else 103,
            "fontsize": 45,
            "text": "RZ",
        },
    ]
    ...
    icn["TP.NUCLEAR DETONATIONS GROUND ZERO"] = [
        {
            "type": "path",
            "fill": "rgb(255,255,0)" if not monoColor else False,
    ...
    missing_tp_keys = [
        "ACOUSTIC FIX",
        "ALTERNATE DECONTAMINATION POINT (UNSPECIFIED)",
        ...
        "CHEMICAL",
        "DECONTAMINATION POINT (EQUIPMENT AND TROOPS)",
        "DECONTAMINATION POINT (EQUIPMENT)",
        "DECONTAMINATION POINT (TROOPS)",
        "DECONTAMINATION POINT (UNSPECIFIED)",
        "DIRECTIONAL MINE",
        "DITAK",
        "DRP",
