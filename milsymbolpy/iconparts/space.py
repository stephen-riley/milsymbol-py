...
def space(ms, iconParts, metadata, colors, STD2525, monoColor, alternateMedal):
    ...
    icn["SP.I.FF.SPACE STATION"] = [
        {
            ...
            "fill": iconFillColor if STD2525 else none,
        },
        {
            "type": "path",
            "fill": False,
    ...
    if STD2525 or numberSIDC:
        icn["SPACE.MISSILE.ICON"]["fill"] = (
            colors["fillColor"]["Unknown"]
            if frame
            else colors["iconFillColor"]["Unknown"]
        )
