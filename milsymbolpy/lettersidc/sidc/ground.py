...
def ground(ms, sId, bbox, icn, _STD2525):
    # GROUND ========================================================================
    sId["S-G-------"] = []
    sId["S-G-U-----"] = []
    ...
    sId["S-G-UCVR--"] = (
        ...
        if _STD2525
        else [icn["GR.IC.AVIATION ROTARY WING"]]
    )
    sId["S-G-UCVRA-"] = [
        icn["GR.IC.AVIATION ROTARY WING"],
        icn["GR.M1.ATTACK"],
    ...
    sId["S-G-UCFRS-"] = [
        ms._scale(0.8, icn["GR.IC.FIELD ARTILLERY"]),
        icn["GR.M1.SINGLE ROCKET LAUNCHER"],
        ([] if _STD2525 else icn["GR.IC.ARMOUR"]),
    ]
    sId["S-G-UCFRSS"] = [
        ms._scale(0.8, icn["GR.IC.FIELD ARTILLERY"]),
        icn["GR.M1.SINGLE ROCKET LAUNCHER"],
    ...
    sId["S-G-UCFRM-"] = [
        ...
        ("" if _STD2525 else icn["GR.M2.CROSS-COUNTRY TRUCK"]),
    ]
    ...
    sId["S-G-UCRV--"] = [
        icn["GR.IC.FF.RECONNAISSANCE"],
        (icn["GR.M2.CAVALRY"] if _STD2525 else []),
    ]
    ...
    sId["S-G-UCRRD-"] = [
        icn["GR.IC.FF.RECONNAISSANCE"],
        icn["GR.IC.FF.AMPHIBIOUS"],
        (icn["GR.M1.MARINE DIVISION"] if _STD2525 else []),
    ]
    sId["S-G-UCRRF-"] = [
        icn["GR.IC.FF.RECONNAISSANCE"],
        icn["GR.IC.FF.AMPHIBIOUS"],
    ...
    sId["S-G-UUACRS"] = [
        ...
        icn["GR.IC.ARMOUR"],
        icn["GR.M2.WHEELED"],
        (icn["GR.M1.CHEMICAL SURVEILLANCE"] if _STD2525 else []),
    ]
