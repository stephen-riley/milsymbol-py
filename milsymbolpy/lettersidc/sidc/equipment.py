...
def equipment(ms, sId, bbox, icn, _STD2525):
    ...
    sId["S-G-EWHLS-"] = [
        ms._translate(
            0, -15, ms._scale(0.8, [icn["GR.EQ.HOWITZER"], icn["GR.EQ.SHORT RANGE"]])
        ),
    ...
    sId["S-G-EWHHS-"] = [
        ms._translate(
            0, -15, ms._scale(0.8, [icn["GR.EQ.HOWITZER"], icn["GR.EQ.LONG RANGE"]])
        ),
        icn["GR.EQ.HOWITZER TRACKED"],
    ]
    ...
    if _STD2525:
        ...
        sId["S-G-EVST--"] = [icn["GR.EQ.TRAIN LOCOMOTIVE"]]
    ...
    # This sets up the bounding boxes for equipment to have the bottom at the right place.
    # (this will be used for mobility when unframed)
    equipmentBottom = {
        "E-----": 0,
        "EWM---": 140,
        "EWMA--": 140,
    ...
    for key, val in equipmentBottom.items():
        bbox["S-G-" + key] = {
            "x1": 50,
            "x2": 150,
            "y1": 50,
