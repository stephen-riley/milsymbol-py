...
geometries = {
    "AirHostile": {
        ...
        "bbox": BBox({"x1": 45, "y1": 20, "x2": 45 + 110, "y2": 20 + 130}),
    },
    "AirFriend": {
        "g": {
            "type": "path",
        ...
        "bbox": BBox({"x1": 45, "y1": 30, "x2": 45 + 110, "y2": 30 + 120}),
    },
    "AirNeutral": {
    ...
    "AirUnknown": {
        ...
        "bbox": BBox({"x1": 25, "y1": 20, "x2": 25 + 150, "y2": 20 + 130}),
    },
    "GroundHostile": {
    ...
    "GroundFriend": {
        ...
        "bbox": BBox({"x1": 25, "y1": 50, "x2": 25 + 150, "y2": 50 + 100}),
    },
    "GroundNeutral": {
        "g": {"type": "path", "d": "M45,45 l110,0 0,110 -110,0 z"},
        "bbox": BBox({"x1": 45, "y1": 45, "x2": 45 + 110, "y2": 45 + 110}),
    },
    "GroundUnknown": {
        "g": {
            "type": "path",
    ...
    "SeaFriend": {
        ...
        "bbox": BBox({"x1": 40, "y1": 40, "x2": 40 + 120, "y2": 40 + 120}),
    },
    "SeaNeutral": {
        "g": {"type": "path", "d": "M45,45 l110,0 0,110 -110,0 z"},
        "bbox": BBox({"x1": 45, "y1": 45, "x2": 45 + 110, "y2": 45 + 110}),
    ...
    "SubsurfaceHostile": {
        ...
        "bbox": BBox({"x1": 45, "y1": 50, "x2": 45 + 110, "y2": 50 + 130}),
    },
    "SubsurfaceFriend": {
        "g": {"type": "path", "d": "m 45,50 c 0,100 40,120 55,120 15,0 55,-20 55,-120"},
        "bbox": BBox({"x1": 45, "y1": 50, "x2": 45 + 110, "y2": 50 + 120}),
    },
    "SubsurfaceNeutral": {
    ...
    "SubsurfaceUnknown": {
        ...
        "bbox": BBox({"x1": 25, "y1": 50, "x2": 25 + 150, "y2": 50 + 130}),
    },
    "PositionMarker": {
