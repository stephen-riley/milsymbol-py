def tactical_points(sidc):
    ...
    sidc["131001"] = (
        actionPoint1  # Command and Control Points / Fly-To-Point / Sonobuoy
    )
    ...
    sidc["281800"] = (
        actionPoint  # Protection Points / General Decontamination Point/Site
    )
    sidc["281801"] = (
        actionPoint  # Protection Points / General Decontamination Point/Site / Alternate
    )
    sidc["281802"] = (
        actionPoint  # Protection Points / General Decontamination Point/Site / Equipment
    )
    sidc["281803"] = (
        actionPoint  # Protection Points / General Decontamination Point/Site / Troop
    )
    sidc["281804"] = (
        actionPoint  # Protection Points / General Decontamination Point/Site / Equipment/Troop
    )
    sidc["281805"] = (
        actionPoint  # Protection Points / General Decontamination Point/Site / Operational
    )
    sidc["281806"] = (
        actionPoint  # Protection Points / General Decontamination Point/Site / Thorough
    )
    sidc["281807"] = (
        actionPoint  # Protection Points / General Decontamination Point/Site / Main Equipment
    )
    sidc["281808"] = (
        actionPoint  # Protection Points / General Decontamination Point/Site / Forward Troop
    )
    sidc["281809"] = (
        actionPoint  # Protection Points / General Decontamination Point/Site / Wounded Personnel
    )
    sidc[
        "281901"
    ...
    sidc["320100"] = (
        actionPoint  # Sustainment Points / Ambulance Points / Ambulance Exchange Point
    )
    sidc["320101"] = (
        actionPoint  # Sustainment Points / Ambulance Points / Ambulance Exchange Point
    )
    sidc["320102"] = (
        actionPoint  # Sustainment Points / Ambulance Points / Ambulance Control Point
    )
    sidc["320103"] = (
        actionPoint  # Sustainment Points / Ambulance Points / Ambulance Load Point
    )
    sidc["320104"] = (
        actionPoint  # Sustainment Points / Ambulance Points / Ambulance Relay Point
    )
    sidc["320200"] = actionPoint  # Sustainment Points / Ammunition Supply Point
    sidc["320300"] = (
        actionPoint  # Sustainment Points / Ammunition Transfer and Holding Point
    )
    ...
    sidc["320800"] = (
        actionPoint  # Sustainment Points / Enemy Prisoner of War (EPW) Collection Point
    )
    sidc["320900"] = actionPoint  # Sustainment Points / Logistics Release Point
    sidc["321000"] = actionPoint  # Sustainment Points / Maintenance Collection Point
    sidc["321100"] = (
        actionPoint  # Sustainment Points / Rearm, Refuel and Resupply Point
    )
    sidc["321200"] = actionPoint  # Sustainment Points / Refuel on the Move (ROM) Point
    sidc["321300"] = actionPoint  # Sustainment Points / Traffic Control Post (TCP)
    sidc["321400"] = actionPoint  # Sustainment Points / Trailer Transfer Point
    sidc["321500"] = (
        actionPoint  # Sustainment Points / Unit Maintenance Collection Point
    )
    sidc["321600"] = actionPoint  # Sustainment Points / Supply Point
    sidc["321601"] = actionPoint  # Sustainment Points / Supply Point / Class I
    sidc["321602"] = actionPoint  # Sustainment Points / Supply Point / Class II
    sidc["321603"] = actionPoint  # Sustainment Points / Supply Point / Class III
    sidc["321604"] = actionPoint  # Sustainment Points / Supply Point / Class IV
    sidc["321605"] = actionPoint  # Sustainment Points / Supply Point / Class V
    sidc["321606"] = actionPoint  # Sustainment Points / Supply Point / Class VI
    sidc["321607"] = actionPoint  # Sustainment Points / Supply Point / Class VII
    sidc["321608"] = actionPoint  # Sustainment Points / Supply Point / Class VIII
    sidc["321609"] = actionPoint  # Sustainment Points / Supply Point / Class IX
    sidc["321610"] = actionPoint  # Sustainment Points / Supply Point / Class X
    sidc["321611"] = actionPoint  # Sustainment Points / Supply Point / General
    sidc["321612"] = actionPoint  # Sustainment Points / Supply Point / NATO Class I
    sidc["321613"] = actionPoint  # Sustainment Points / Supply Point / NATO Class II
    sidc["321614"] = actionPoint  # Sustainment Points / Supply Point / NATO Class III
    sidc["321615"] = actionPoint  # Sustainment Points / Supply Point / NATO Class IV
    sidc["321616"] = actionPoint  # Sustainment Points / Supply Point / NATO Class V
    sidc["321700"] = (
        actionPoint  # Sustainment Points / Medical Evacuation Point (MEDEVAC) Pick-up Point
    )
    sidc["330100"] = actionPoint2  # Mission Tasks / Block
    sidc["330200"] = actionPoint2  # Mission Tasks / Breach
    sidc["330300"] = actionPoint2  # Mission Tasks / Bypass
    sidc["330400"] = actionPoint2  # Mission Tasks / Canalize
    sidc["330500"] = actionPoint2  # Mission Tasks / Clear
    sidc["330600"] = actionPoint2  # Mission Tasks / Contain
    sidc["330700"] = actionPoint2  # Mission Tasks / Counterattack
    sidc["330800"] = actionPoint2  # Mission Tasks / Counterattack by Fire
    sidc["330900"] = actionPoint2  # Mission Tasks / Delay
    sidc["331000"] = actionPoint2  # Mission Tasks / Destroy
    sidc["331100"] = actionPoint2  # Mission Tasks / Disrupt
    sidc["331200"] = actionPoint2  # Mission Tasks / Fix
    sidc["331300"] = actionPoint2  # Mission Tasks / Follow and Assume
    sidc["331400"] = actionPoint2  # Mission Tasks / Follow and Support
    sidc["331500"] = actionPoint2  # Mission Tasks / Interdict
    sidc["331600"] = actionPoint2  # Mission Tasks / Isolate
    sidc["331700"] = actionPoint2  # Mission Tasks / Neutralize
    sidc["331800"] = actionPoint2  # Mission Tasks / Occupy
    sidc["331900"] = actionPoint2  # Mission Tasks / Penetrate
    sidc["332000"] = actionPoint2  # Mission Tasks / Retain
    sidc["332100"] = actionPoint2  # Mission Tasks / Retire
    sidc["332200"] = actionPoint2  # Mission Tasks / Secure
    sidc["332300"] = actionPoint2  # Mission Tasks / Screen
    sidc["332400"] = actionPoint2  # Mission Tasks / Support by Fire
    sidc["332500"] = actionPoint2  # Mission Tasks / Withdraw
    sidc["332600"] = actionPoint2  # Mission Tasks / Withdraw under Pressure
