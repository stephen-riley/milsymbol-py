...
from ...iconparts.subsurface import subsurface as icons


def minewarfare(ms, sId, sIdm1, sIdm2, bbox, symbolSet, icn, _STD2525, edition):
    # Mine Warfare
    if symbolSet == "36":
        ...
        sId["140100"] = [ms._scale(1.3, icn["SU.IC.SEA MINE MILCO"], True)]
        sId["140101"] = [
            ms._scale(
                1.3,
                [
        ...
        sId["150000"] = [ms._scale(1.3, icn["SU.IC.SEA MINE MILEC"], True)]
        ...
        sId["160000"] = [
            ms._scale(1.3, icn["SU.IC.SEA MINE NEGATIVE REACQUISITION"], True)
        ]
        ...
        sId["170000"] = [ms._scale(1.3, icn["SU.IC.SEA MINE GENERAL OBSTRUCTOR"], True)]
        sId["170100"] = [icn["SU.IC.SEA MINE GENERAL OBSTRUCTOR NEUTRALIZED"]]
        sId["180000"] = [ms._scale(1.3, icn["SU.IC.SEA MINE MINE ANCHOR"], True)]
        sId["190000"] = [
            ms._scale(1.3, icn["SU.IC.SEA MINE NON-MINE MINE-LIKE CONTACT"], True)
        ]
