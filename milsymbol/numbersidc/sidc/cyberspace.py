...
def cyberspace(ms, sId, sIdm1, sIdm2, bbox, symbolSet, icn, _STD2525, edition):
    ...
    if symbolSet == "60":
        ...
        sId["110100"] = (
            ...
            if edition == "D"
            else [icn["CY.IC.COMBAT MISSION TEAM"]]
        )
        sId["110200"] = (
            [icn["CY.IC.HERDER"]]
            if edition == "D"
            else [icn["CY.IC.NATIONAL MISSION TEAM"]]
        )
        sId["110300"] = (
            [icn["CY.IC.CALLBACK DOMAIN"]]
            if edition == "D"
            else [icn["CY.IC.CYBER PROTECTION TEAM"]]
        )
        sId["110400"] = [icn["CY.IC.ZOMBIE"]] if edition == "D" else []  # Disused
        sId["110500"] = []  # Disused
        ...
        sId["120000"] = [] if edition == "D" else [icn["CY.IC.THREAT ACTOR"]]
        ...
        sId["130000"] = []
        sId["130100"] = (
            [icn["CY.IC.NORMAL"]] if edition == "D" else [icn["CY.IC.FIREWALL"]]
        )
        sId["130200"] = (
            [icn["CY.IC.NETWORK OUTAGE"]] if edition == "D" else [icn["CY.IC.FIRMWARE"]]
        )
        sId["130300"] = [icn["CY.IC.UNKNOWN"]]
        sId["130400"] = [icn["CY.IC.IMPAIRED"]]

        sId["140000"] = [] if edition == "D" else [icn["CY.IC.APPLICATION"]]
        sId["140100"] = [icn["CY.IC.CORE ROUTER"]]
        sId["140200"] = [icn["CY.IC.ROUTER TEXT"]]
        sId["140300"] = (
            [icn["CY.IC.CROSS DOMAIN SOLUTION"]]
            if edition == "D"
            else [icn["CY.IC.SEARCH ENGINE"]]
        )
        sId["140400"] = (
            [icn["CY.IC.MAIL SERVER"]]
            if edition == "D"
            else [icn["CY.IC.SOCIAL MEDIA"]]
        )
        ...
        sId["150100"] = (
            ...
            if edition == "D"
            else [icn["CY.IC.MALWARE"]]
        )
        sId["150200"] = (
            [icn["CY.IC.GOVERNMENT"]] if edition == "D" else [icn["CY.IC.PHISIHNG"]]
        )
        sId["150300"] = (
            [icn["CY.IC.CONTRACTOR"]]
            if edition == "D"
            else [icn["CY.IC.SPEAR PHISIHNG"]]
        )
        sId["150400"] = (
            [icn["CY.IC.SUPERVISORY CONTROL AND DATA ACQUISITION (SCADA)"]]
            if edition == "D"
            else [icn["CY.IC.WHALE PHISHING"]]
        )
        sId["150500"] = [icn["CY.IC.NON-GOVERNMENT"]]

        sId["160000"] = [] if edition == "D" else [icn["CY.IC.DOCUMENT"]]
        sId["160100"] = (
            [icn["CY.IC.INFECTION"]] if edition == "D" else [icn["CY.IC.CRYPTO"]]
        )
        sId["160200"] = (
            [icn["CY.IC.DEGRADATION"]] if edition == "D" else [icn["CY.IC.PERSONA"]]
        )
        ...
        if not _STD2525 and edition == "E":  # This is APP6
            # APP6E overrides
            pass
