...
def landunit(ms, sId, sIdm1, sIdm2, bbox, symbolSet, icn, _STD2525, edition):
    # Land Unit
    if symbolSet == "10":
        ...
        sId["130301"] = [
            ms._scale(0.8, icn["GR.IC.FIELD ARTILLERY"], True),
            icn["GR.IC.ARMOUR"],
        ...
        sIdm1["01"] = [
            ...
            if _STD2525
            else icn["GR.M1.AIRMOBILE/AIR ASSAULT"]
        ]
        ...
        sIdm1["56"] = [
            icn["GR.M1.WEAPON"] if _STD2525 else icn["GR.M1.SENSOR CONTROL MODULE"]
        ]
        sIdm1["57"] = [icn["GR.M1.SIGNALS INTELLIGENCE"]]
        sIdm1["58"] = [
            icn["GR.M1.ARMORED"] if _STD2525 else icn["GR.M1.SINGLE SHELTER SWITCH"]
        ]
        ...
        sIdm1["71"] = [
            icn["GR.M1.MOBILITY ASSAULT"] if _STD2525 else icn["GR.M1.ACCIDENT"]
        ]
        sIdm1["72"] = [
            icn["GR.M1.AMPHIBIOUS WARFARE SHIP "] if _STD2525 else icn["GR.M1.OTHER"]
        ]
        sIdm1["73"] = [
            icn["GR.M1.LOAD HANDLING SYSTEM"] if _STD2525 else icn["GR.M1.CIVILIAN"]
        ]
        sIdm1["74"] = [
            icn["GR.M1.PALLETIZED LOAD SYSTEM"]
            if _STD2525
            else icn["GR.M1.ANTISUBMARINE WARFARE"]
        ]
        ...
        sIdm1["81"] = (
            ...
            if edition == "D"
            else [icn["GR.M1.NATO MEDICAL ROLE 2 BASIC"]]
        )
        sIdm1["82"] = (
            [icn["GR.M1.JOINT NETWORK NODE"]]
            if edition == "D"
            else [icn["GR.M1.NATO MEDICAL ROLE 2 ENHANCED"]]
        )
        sIdm1["83"] = (
            [icn["GR.M1.RETRANSMISSION SITE"]]
            if edition == "D"
            else [icn["GR.M1.NATO MEDICAL ROLE 2 FORWARD"]]
        )
