...
def activites(ms, sId, sIdm1, sIdm2, bbox, symbolSet, icn, _STD2525, edition):
    ...
    if symbolSet == "40":
        ...
        sId["110123"] = [
            ms._translate(
                0, 10, ms._scale(0.8, icn["AC.IC.CRIMINAL.ACTIVITY.INCIDENT"])
            ),
            icn["AC.M1.THREAT"],
        ]
        ...
        sId["110302"] = [
            ms._translate(
                0, 15, ms._scale(0.7, [icn["ST.IC.EXPLOSION"], icn["ST.IC.IED"]])
            ),
            icn["ST.M1.PREMATURE"],
        ]
