def tactical_points_app6(symbol, sidc):
    ...
    sidc[
        "G-C-MMPOR-"
    ] = {}  # 2.X.2.1.4.1.4.2 OBSERVATION POST OCCUPIED BY DISMOUNTED SCOUTS OR RECONNAISSANCE
    ...
    # sidc['G-C-MMPON-'] = [] #2.X.2.1.4.1.4.6 Duplicate in source?
    # sidc['G-C-MMPON-'] = [] #2.X.2.1.4.1.4.7 Duplicate in source?
    sidc["G-C-MOPD--"] = {}  # 2.X.2.1.5.1.1 POINT OF DEPARTURE
    sidc[
        "G-C-BOATD-"
    ] = {}  # 2.X.2.2.1.3.3 ANTITANK OBSTACLES, TETRAHEDRONS, DRAGON'S TEETH AND OTHER SIMILAR OBSTACLES
    ...
    sidc[
        "G-C-BOAMC-"
    ] = {}  # 2.X.2.2.1.5.4 ANTITANK MINE (ARROW SHOWS EFFECTS) "CLAYMORE MINE"
    ...
    sidc[
        "G-O-VH----"
    ] = {}  # 2.X.3.1.14 HELICOPTER (CIVILIAN BEING USED BY HOSTILE OR INSURGENTS
