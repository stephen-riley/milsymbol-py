...
try:
    from ...iconparts.ground import ground
except ImportError:
    ground = None
try:
    from ...iconparts.air import air
except ImportError:
    air = None
from ..labels.tactical_points_app6 import tactical_points_app6 as labels


def tactical_points_app6(ms, sidc, bbox, icn, _STD2525):
    ...
    bbox["G-C-BOAMC-"] = {"x1": 60, "x2: 140, y1": 10, "y2": 140}  # Corrected quote
    ...
    sidc["G-C-BOAID-"] = icn[
        "TP.SCATTERABLE MINEFIELD WITH SELF-DESTRUCT"
    ...
    sidc["G-C-BWI---"] = icn[
        "TP.NUCLEAR DETONATIONS GROUND ZERO PLANNED"
    ]  # 2.X.2.2.4.4
...
exports = {
    ...
    "iconParts": [ground, air, iconParts],
    "labels": labels,
    "icons": tactical_points_app6,
}
