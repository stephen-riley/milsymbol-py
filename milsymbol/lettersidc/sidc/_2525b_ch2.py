...
from ...iconparts._2525b import _2525b as std2525bicons


def std2525b(ms, sId, bbox, icn, _STD2525):
    ...
    # JS: bbox["G-O-SBXD--"] = { x1: 35, x2: 165, y1: 70, y2: 130 };
    # The key in JS is "G-O-SBXD--", but the comment "TACGRP.OTH.SSUBSR.BTMRTN.WRKD" matches "G-O-SBWD--" above?
    # No, SBWD-- is wreak dangerous.
    # SBXD-- is probably something else?
    # In JS code:
    # sId["G-O-SBWD--"] = icn["TP.WRECK, DANGEROUS"];
    # bbox["G-O-SBXD--"] = ...
    # Wait, is the key different? Yes, W vs X.
    # Let's trust the JS code.
