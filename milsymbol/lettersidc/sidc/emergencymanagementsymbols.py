...
try:
    from ...iconparts.ground import ground as icons
except ImportError:
    # Fallback or placeholder if ground isn't fully ready
    # Assuming strict port, we expect it to exist.
    # But for safety during partial implementation of project:
    icons = None

from ...iconparts.tactical_points import tacticalPoints as tacticalpoints


def emergencymanagementsymbols(ms, sId, bbox, icn, _STD2525):
    ...
    ]  # Note: JS likely had typo "NON-REsIdENTIAL", keeping it if it matches key in ground.js properly. Wait, "REsIdENTIAL" looks like a typo in JS variable naming or search/replace but the KEY string is what matters. The key string in JS is "AC.IC.NON-REsIdENTIAL FIRE".
    # However, standard english is "NON-RESIDENTIAL".
    # Checking tactical_points or ground.js for definition would be wise.
    # But I should stick to 1:1 with JS provided content.
    ...
    sId["E-O-A-----"] = sId["E-O-AA----"] = sId["E-O-AB----"] = sId["E-O-AC----"] = sId[
        "E-O-AD----"
    ...
    sId["E-O-B-----"] = sId["E-O-BA----"] = sId["E-O-BB----"] = sId["E-O-BC----"] = [
    ...
    sId["E-O-BK----"] = sId.get("S-G-USSW--", [])
    sId["E-O-BL----"] = [
        icn["ST.IC.FOOD DISTRIBUTION"],
        icn["AC.M1.EMERGENCY"],
    ]
    sId["E-O-C-----"] = sId["E-O-CA----"] = sId["E-O-CB----"] = sId["E-O-CE----"] = [
        icn["GR.IC.FIRE PROTECTION"]
    ]
    sId["E-O-CC----"] = [icn["AC.IC.FIRE HYDRANT"]]
    sId["E-O-CD----"] = [icn["AC.IC.OTHER WATER SUPPLY LOCATION"]]
    sId["E-O-D-----"] = sId["E-O-DA----"] = sId["E-O-DB----"] = sId["E-O-DC----"] = [
        icn["GR.IC.FF.LAW ENFORCEMENT"]
    ]
    sId["E-O-DD----"] = sId["E-O-DDA---"] = sId["E-O-DDB---"] = sId["E-O-DDC---"] = [
        icn[
            "GR.IC.BUREAU OF ALCOHOL, TOBACCO, FIREARMS AND EXPLOSIVES (ATF) (DEPARTMENT OF JUSTICE)"
        ],
    ]
    sId["E-O-DE----"] = sId["E-O-DEA---"] = sId["E-O-DEB---"] = sId["E-O-DEC---"] = [
        icn["GR.IC.FF.BORDER PATROL"]
    ]
    sId["E-O-DF----"] = sId["E-O-DFA---"] = sId["E-O-DFB---"] = sId["E-O-DFC---"] = [
        icn["GR.IC.FF.CUSTOMS SERVICE"]
    ]
    sId["E-O-DG----"] = sId["E-O-DGA---"] = sId["E-O-DGB---"] = sId["E-O-DGC---"] = [
        icn["GR.IC.DRUG ENFORCEMENT AGENCY (DEA)"]
    ]
    sId["E-O-DH----"] = sId["E-O-DHA---"] = sId["E-O-DHB---"] = sId["E-O-DHC---"] = [
        icn["GR.IC.FF.DEPARTMENT OF JUSTICE (DOJ)"]
    ]
    sId["E-O-DI----"] = sId["E-O-DIA---"] = sId["E-O-DIB---"] = sId["E-O-DIC---"] = [
    ...
    sId["E-F-EA----"] = [
        ms._translate(0, 15, ms._scale(0.75, icn["GR.IN.IC.ELECTRIC POWER"], True)),
...
exports = {
    ...
    "icons": emergencymanagementsymbols,
}
